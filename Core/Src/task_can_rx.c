...
//								tmp.bus_current);
			...
			case CMMC_AUTO_CONTROL_FRAME_ID:
			{
				...
				ab_ptr->from_controller.front_left_angle = cmmc_auto_control_front_left_setpoint_decode(tmp.front_left_setpoint);
				ab_ptr->from_controller.front_right_angle = cmmc_auto_control_front_right_setpoint_decode(tmp.front_right_setpoint);
				ab_ptr->from_controller.rear_angle = cmmc_auto_control_rear_setpoint_decode(tmp.rear_setpoint);
